...
def IK(x, y, z):
    ...
    ticks2 = radians_to_ticks(theta2) + 2653
...
def FK(ticks1, ticks2, ticks3):
    ...
    theta2 = ticks_to_radians(ticks2 - 2653)
...
x3 = np.linspace(x_max, x_min, x_steps)
z3 = z_max*np.ones(x_steps)

x4 = x_min*np.ones(z_steps)
z4 = np.linspace(z_max, z_min, z_steps)
